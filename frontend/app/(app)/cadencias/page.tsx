...
export const metadata = { title: 'BSSP — Cadências' };
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Editar cadências e gerir templates v1.</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Para Marketing e Admin. S3 traz CRUD completo + versionamento.</CardDescription>
        </CardHeader>
