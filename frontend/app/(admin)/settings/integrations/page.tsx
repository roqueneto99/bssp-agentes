...
export const metadata = { title: 'BSSP — Integrações' };
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">RD Station, Hablla, SendGrid, LLM.</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Admin. S6 entrega.</CardDescription>
        </CardHeader>
